...
REQUIRED_FILES = [
    ...
    "templates/project/scripts/bibliography.py",
    "templates/project/scripts/read_paper.py",
    "templates/project/scripts/dossier.py",
    "templates/project/llm-wiki/dossier/README.md",
